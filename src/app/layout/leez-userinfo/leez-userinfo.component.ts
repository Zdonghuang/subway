import { LeezInfoService } from './leez-userinfo.service';
import { Component, OnInit } from '@angular/core';
import { flatten } from '@angular/compiler';

@Component({
  selector: 'app-leez-userinfo',
  templateUrl: './leez-userinfo.component.html',
  styleUrls: ['./leez-userinfo.component.scss']
})
export class LeezInfoComponent implements OnInit {
  ...
  showtext = false;
  prev = false;
  constructor(private http: LeezInfoService) { }
    ...
    const html = '<html><head><meta charset="utf-8" /></head><body>' +
     document.getElementById(table).outerHTML +
      ...
      // console.log(html);
        ...
        e.target.download = 'Leez用户信息列表.xls';
  }
}
